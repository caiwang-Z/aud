...
1.5. 变体问题(问题内核仍是背包)： 最后一块石头的重量 II， [代码](https://leetcode.cn/problems/last-stone-weight-ii/description/), 目标和，[代码](https://leetcode.cn/problems/target-sum/description/)
3. 完全背包，基础代码见pycharm. 
